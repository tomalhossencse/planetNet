...
const Header = ({ onToggleSideBar, role, user }) => {
  return (
    <div className="bg-white/80 dark:bg-slate-900/80  backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-700/50 px-6 py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-2xl hidden md:block font-bold text-slate-800 dark:text-white">
              Dashboard
            </h1>
            <p className="text-sm hidden xl:block text-slate-800 dark:text-slate-200">
              Welcome back, {user?.displayName}! here's what's happing today.
            </p>
          </div>
        </div>
        ...
        <div className="flex-1 max-w-md md:mx-8 mx-4">
